...
declare_id!("2wgNYNjMGvJoipXdmWxTRdBTsbs6T5TDzh5hy7Cotnaw");

#[program]
pub mod frontrunning_vulnerable {
    use super::*;
    ...
    // Maker can change price anytime
